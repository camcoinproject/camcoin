...
const string strMessageMagic = "Camcoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    else if (pindexBest->nHeight+1 <= 20)
    {
      nSubsidy = 0 * COIN;
      return nSubsidy + nFees;
    }
...
static const int64_t nTargetTimespan = 20 * 30;  // 10 mins
//
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Camcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Blockchain.info Block #309890 2014-06-28 02:54:28";
        CTransaction txNew;
		txNew.nTime = 1404885150;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x36246a8ed444803e728c36be7c6f57a32eb0b924954b8d69d00fbd36ba65b0b8"));
